...
resumen: >-
  La ciencia moderna decidió que un resultado es 'significativo' si la
  probabilidad de que ocurra por azar es menor al 5%. El criterio tiene 90 años,
  fue adoptado por convención y su creador advirtió que no debía usarse como se
  usa. La crisis de replicación de la última década sugiere que ese umbral nos
  ha llevado a creer cosas que probablemente no son verdad.
atlas:
  - p-hacking
  - baja-potencia-estadística
pregunta: >-
  ¿Qué pasa cuando una convención estadística se convierte en el árbitro de la
  verdad?
condiciones:
