...
resumen: >-
  Médicos y pacientes toman decisiones distintas según cómo se presentan los
  mismos datos. El sistema elige, casi siempre, el número más grande (riesgo
  relativo) sobre el más útil (riesgo absoluto).
atlas:
  - sobreinterpretación
pregunta: >-
  ¿Qué pasa cuando el mismo dato se presenta de dos formas y una siempre
  convence más?
condiciones: []
publicado: false
---
