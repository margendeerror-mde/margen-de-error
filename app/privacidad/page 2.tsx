...
export default function PrivacidadPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-24 min-h-screen">
      ...
      <div className="prose prose-lg content-serif text-black/80 space-y-6">
        <p>
        ...
        <h2 className="text-xl font-bold text-black mt-8 mb-4">Exención Global de Responsabilidad</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-black mt-8 mb-4">Enlaces a Terceros</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-black mt-8 mb-4">Privacidad y Tratamiento de Datos</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-black mt-8 mb-4">Modificaciones</h2>
        <p>
